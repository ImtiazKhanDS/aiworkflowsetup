...
2. User creates or selects a project.
   3Six-File+Context+Methodology.zip. User enters the project workspace.
3. User optionally imports a starter system design template into the canvas.
4. User prompts the AI to generate or extend the system design.
5. AI generates nodes and edges in the shared canvas.
6. Collaborators edit and refine the design.
7. User triggers spec generation.
8. App persists the generated Markdown spec.
9. User reviews or downloads the spec.
